...
public class C0204MethodOverloading {
    ...
    //접근제어자를 안붙이면 기본적으로 default 접근제어자 : 같은 패키지 내 유효
    //static 안붙이면, C0204MethodOverloading c1 = new C0204MethodOverloading(); 객체 생성해서 함수 호출
    int sum (int a, int b){
        return a+b;
    }

    //매개변수의 타입 또는 개수가 다르면 같은 메소드 정의 가능 = 메소드 오버로딩
